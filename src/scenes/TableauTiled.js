class TableauTiled extends Tableau{
    ...
    preload() {
        ...
        this.load.tilemapTiledJSON('map', 'assets/tilemaps/niveauAlpha03.json');
    ...
    create() {
        ...
        this.tileset = this.map.addTilesetImage('platforms','tiles');
      ...
      /*  this.bonus=this.physics.add.group();
        ...
        let logo1= this.add.image(300, 500, 'logo1');
